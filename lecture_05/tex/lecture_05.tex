...
\parbox{\textwidth}{Скалярные и векторные поля. Поверхности уровня. Векторные линии. Градиент и его свойства. Потенциальный вектор и его свойства. Градиент вектора по вектору. Субстанциональная производная.
}
}
...
%\input{../img/pstricks/integral.tex}
\end{column}
