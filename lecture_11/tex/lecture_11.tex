...
\frame{
	...
	\begin{proof}
		\parbox{\textwidth}{
		Доказательство очевидно и вытекает из правила произведения тензоров как матриц и предыдущей теореме о полном тензоре.			
		}
	\end{proof}
}
